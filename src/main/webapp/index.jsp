...
<body>
  <div class="jumbotron" style="background-color:white">
     <h1 class="text-center">Welcome to git Lab</h1>
      ...
      <h2 class="text-center">WELLCOME TO ALL FOR DEVOPS Traning on behalf of Infinito Solutionsdd lokesh welcome lokiu</h2>
